...
const ALL_DESTINATIONS = [
  ...
  { name: "Bora Bora", slug: "bora-bora", country: "French Polynesia", emoji: "🌺", img: "https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&w=800&q=80", tag: "Paradise", color: "#06b6d4", desc: "Turquoise lagoon & Mount Otemanu" },
  { name: "New York", slug: "new-york", country: "USA", emoji: "🗽", img: "https://images.unsplash.com/photo-1490644658840-3f2e3f8c5625?auto=format&fit=crop&w=800&q=80", tag: "City", color: "#0F6CF5", desc: "Broadway, Central Park & skyline" },
  ...
  { name: "Swiss Alps", slug: "swiss-alps", country: "Switzerland", emoji: "🏔️", img: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?auto=format&fit=crop&w=800&q=80", tag: "Adventure", color: "#64748b", desc: "Skiing, chalets & mountain views" },
  { name: "Kenya Safari", slug: "kenya-safari", country: "Kenya", emoji: "🦁", img: "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=800&q=80", tag: "Adventure", color: "#f59e0b", desc: "Big Five & Maasai Mara" },
  ...
  { name: "Cape Town", slug: "cape-town", country: "South Africa", emoji: "🇿🇦", img: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?auto=format&fit=crop&w=800&q=80", tag: "Scenic", color: "#10b981", desc: "Table Mountain & Cape Winelands" },
  ...
  { name: "Rio de Janeiro", slug: "rio", country: "Brazil", emoji: "🇧🇷", img: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?auto=format&fit=crop&w=800&q=80", tag: "Vibrant", color: "#10b981", desc: "Christ the Redeemer & Copacabana" },
  { name: "Côte d'Azur", slug: "cote-dazur", country: "France", emoji: "⛵", img: "https://images.unsplash.com/photo-1562883676-8c7feb83f09b?auto=format&fit=crop&w=800&q=80", tag: "Luxury", color: "#06b6d4", desc: "Nice, Monaco & Saint-Tropez" },
  { name: "Queenstown", slug: "queenstown", country: "New Zealand", emoji: "🇳🇿", img: "https://images.unsplash.com/photo-1469521669194-babb45599def?auto=format&fit=crop&w=800&q=80", tag: "Adventure", color: "#64748b", desc: "Bungee jumping & fjords" },
  ...
  { name: "Costa Rica", slug: "costa-rica", country: "Costa Rica", emoji: "🦜", img: "https://images.unsplash.com/photo-1518259102261-b40117eabbc9?auto=format&fit=crop&w=800&q=80", tag: "Nature", color: "#10b981", desc: "Rainforest, volcanoes & sloths" },
  { name: "Tanzania", slug: "tanzania", country: "Tanzania", emoji: "🦒", img: "https://images.unsplash.com/photo-1549366021-9f761d450615?auto=format&fit=crop&w=800&q=80", tag: "Safari", color: "#f59e0b", desc: "Serengeti & Kilimanjaro" },
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 16px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 16 }}>
          {ALL_DESTINATIONS.map((d, i) => (
            <Link key={d.name} href={`/destinations/${d.slug || d.name.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}`} style={{ textDecoration: "none", display: "block", borderRadius: 20, overflow: "hidden", position: "relative", aspectRatio: "4/3" }}>
