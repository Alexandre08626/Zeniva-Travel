      ...
      <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 24, padding: 48, maxWidth: 520, width: "100%", textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 12, marginBottom: 28 }}>
          {paymentStatus === "failed"
            ...
            : "A confirmation email will be sent within 24 hours. Your booking is saved in My Trips."}
        </p>
        <div style={{ display: "grid", gap: 10 }}>
          <a href="/trips" style={{ display: "block", background: `linear-gradient(135deg, ${BLUE}, ${NAVY})`, color: "white", textDecoration: "none", borderRadius: 9999, padding: "14px 32px", fontWeight: 800, fontSize: 15 }}>
            📋 View My Trips
          </a>
