...
export async function GET() {
  return new ImageResponse(
    (
      ...
      >
        {/* Glow orbs */}
        <div style={{ position: "absolute", top: -60, left: 80, width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(15,108,245,0.25) 0%, transparent 70%)", display: "flex" }} />
        <div style={{ position: "absolute", bottom: -80, right: 60, width: 450, height: 450, borderRadius: "50%", background: "radial-gradient(circle, rgba(230,184,90,0.18) 0%, transparent 70%)", display: "flex" }} />
        <div style={{ position: "absolute", top: 80, right: 150, width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(236,72,153,0.15) 0%, transparent 70%)", display: "flex" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "55px 65px", flex: 1, position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", background: "rgba(236,72,153,0.2)", border: "1px solid rgba(236,72,153,0.4)", borderRadius: 100, padding: "8px 24px" }}>
              <span style={{ color: "#ec4899", fontSize: 15, fontWeight: 800, letterSpacing: "0.08em" }}>CREATOR PROGRAM</span>
            </div>
          </div>
