...
export const metadata: Metadata = {
  title: "Luxury Florida Villa Rentals — AI Travel Concierge | Zeniva Travel",
...
const FAQS = [
  ...
  { q: "Is Zeniva Travel licensed?", a: "Yes. Zeniva Travel is incorporated in Delaware, USA and operates with full compliance. We are an AI-powered travel agency serving all 50 US states and Canada." },
];
