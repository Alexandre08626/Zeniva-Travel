...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "Lina AI for your travel agency. Assistance client 24/7. Installation from CAD $1,500. CAD $599/month includes one advisor; CAD $49/month per additional advisor. Before taxes.",
    images: [
