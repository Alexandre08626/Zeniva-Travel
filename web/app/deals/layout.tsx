...
export const metadata: Metadata = {
  title: "Travel Deals 2025 — Cheap Flights, Hotel Discounts & Last-Minute Vacations | Zeniva Travel",
  description:
  ...
  openGraph: {
    title: "Travel Deals 2025 — Cheap Flights & Vacation Packages | Zeniva Travel",
