      ...
      <div className="mx-auto max-w-6xl px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1.4fr,1fr] items-start">
          ...
          <aside className="space-y-3 lg:sticky lg:top-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-4 space-y-2">
              <div className="text-sm font-semibold" style={{ color: MUTED_TEXT }}>{tripDraft?.accommodationType === 'Hotel' ? 'Hotel' : tripDraft?.accommodationType === 'Yacht' ? 'Yacht' : (tripDraft?.accommodationType === 'Zeniva Home' || tripDraft?.accommodationType === 'Residence') ? 'Zeniva Home' : 'Accommodation'}</div>
