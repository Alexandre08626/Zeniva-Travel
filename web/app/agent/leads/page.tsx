      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            {hq ? "All traveler leads across all agents" : "Your personal lead pipeline"}
          </p>
        </div>
      </div>

      {/* Les onglets B2B (recrutement d'agents et d'agences) ont été retirés :
          cette prospection est gérée par Zenitech. Ne reste que le pipeline voyageurs,
          où arrivent aussi les leads envoyés par Zenitech (POST /api/lead-capture). */}
