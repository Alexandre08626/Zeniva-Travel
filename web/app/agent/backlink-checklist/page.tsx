...
const BLURBS: Record<Dir["blurbKey"], { name: string; short: string; long: string; categoryHint: string; phone: string; email: string; website: string; address: string }> = {
  "en-general": {
    name: "Zeniva Travel",
    short: "AI-powered travel technology platform. Lina AI plans and books luxury vacations, all-inclusive packages, yacht charters and custom trips. Available 24/7. Zero booking fees.",
    long: "Zeniva is an AI-powered travel technology platform incorporated in Delaware (USA). Our concierge Lina AI is available 24/7 in 7 languages and books real flights (Duffel, 300+ airlines), 1.5M+ hotels (LiteAPI), private yachts (36-boat South Florida fleet), short-term rentals (chalets, villas, condos), cruises and full all-inclusive packages. Real human advisors back every AI booking. ZeniPay 0% installment plans. Serving the USA, Canada, the Caribbean and Europe.",
    categoryHint: "Travel Technology Platform / Online Travel Platform / Concierge Service",
  ...
  "fr-quebec": {
    ...
    short: "Plateforme technologique de voyage AI 24/7 en français. Forfaits tout inclus, croisières, chalets ZeniStay fournis par des partenaires tiers. Prix en CAD, vols directs depuis YUL et YQB.",
    long: "Zeniva est une plateforme technologique de voyage AI nord-américaine qui sert le Québec en français. Zeniva agit uniquement comme intermédiaire technologique — les services de voyage sont fournis par des fournisseurs tiers. Lina AI parle français 24/7 (chat ou voix), prix en dollars canadiens, vols directs depuis Montréal (YUL) et Québec (YQB) vers Cuba, Cancún, Punta Cana, Varadero. Tous les forfaits tout-inclus avec vols, hôtel et transferts via partenaires fournisseurs. Chalets ZeniStay au Lac-Beauport, Charlevoix et Mont-Tremblant. Aucuns frais de plateforme, ZeniPay paiements en versements 0% intérêt. Support humain 24/7 pour les imprévus de voyage.",
    categoryHint: "Plateforme technologique de voyage / Voyage tout inclus / Voyages Québec",
    phone: "+1 (332) 290-0021",
    email: "info@zeniva.ca",
  ...
  "en-nyc": {
    ...
    short: "AI travel platform for New York. Direct flights from JFK/LGA/EWR, Hamptons yacht charters, honeymoons, all-inclusive Caribbean packages.",
    long: "Zeniva is an AI-powered travel technology platform serving New York 24/7. Lina AI books direct flights from JFK, LaGuardia (LGA), Newark (EWR), White Plains (HPN) and Stewart (SWF) to the Caribbean, Mexico, Europe, Hawaii and Asia. Specialty: Hamptons yacht charters (East End and Newport summer), honeymoons (Maldives, Bora Bora, Santorini, Amalfi Coast), and Caribbean all-inclusive packages from $1,099. Real Zeniva advisor 24/7 for in-trip support. ZeniPay 0% installments.",
    categoryHint: "Travel Technology Platform / NYC Concierge / Honeymoon Specialist",
    phone: "+1 (332) 290-0021",
    email: "info@zeniva.ca",
  ...
  "en-virginia": {
    ...
    short: "AI travel platform for Virginia. Direct flights from IAD/DCA/RIC/ORF, Norfolk cruises, Williamsburg getaways, government-rate corporate travel.",
    long: "Zeniva is an AI-powered travel technology platform serving Virginia 24/7. Lina AI books direct flights from Washington Dulles (IAD), Reagan National (DCA), Richmond (RIC), Norfolk (ORF), Charlottesville (CHO) and Roanoke (ROA). Specialties: Norfolk cruise terminal departures (Royal Caribbean, Carnival, Norwegian), Williamsburg/Virginia Beach family getaways, and per-diem-compliant corporate travel for DC-area government and contractor staff. ZeniPay 0% installments. Real Zeniva advisor 24/7 for in-trip support.",
    categoryHint: "Travel Technology Platform / Virginia Concierge / Corporate Travel",
    phone: "+1 (332) 290-0021",
    email: "info@zeniva.ca",
