...
const AI_AGENTS: AIAgent[] = [
  ...
  { id: "vera", name: "Vera", emoji: "🛡️", avatar: "/agents/vera.png", status: "live", type: "Compliance & Risk Agent", schedule: "Every 30min", color: "#991b1b", description: "Monitors ZeniPay transactions and flags risk before it becomes a problem. Detects fraud patterns, tracks chargeback ratios, and ensures AML compliance.", features: ["Risk Detection", "Chargeback Alerts", "Compliance", "AML Flags", "Auto-review"], lastAction: "Scan complete" },
  { id: "nova", name: "Nova", emoji: "⭐", avatar: "/agents/nova.png", status: "live", type: "Agent Success & Onboarding", schedule: "Daily + Events", color: "#f59e0b", description: "Activates new agents, coaches performance and reactivates dormant accounts. Sends automated onboarding sequences, performance reports, and personalized coaching tips.", features: ["Onboarding", "Performance", "Reactivation", "Coaching", "Leaderboards"], lastAction: "Welcome email sent" },
