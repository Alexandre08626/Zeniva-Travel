...
export function AgentDashboardPage({ agentId }: { agentId?: string }) {
  ...
  const dashboardHref = useMemo(() => {
    if (isHQorAdmin) return "/agent";
    return resolvedAgentId ? `/agent/${resolvedAgentId}` : "/agent";
  }, [isHQorAdmin, resolvedAgentId]);
  ...
  const navLinks = useMemo(() => {
    ...
    return [
      ...
      { label: "🤖 AI Agents", href: "/agent/agents-dashboard" },
      ...(isHQorAdmin
        ? [
