...
export default function P() { return (
  <SeoPage h1="Rencontre Lina — Ton concierge IA de voyage" subtitle="Lina est l'IA derrière Zeniva. Elle planifie ton voyage en secondes, réserve de vrais vols et hôtels chez des partenaires licenciés, et te transfère à un conseiller humain quand tu en as besoin. Disponible 24/7 en 6 langues."
    ...
    sections={[
      { heading: "Qui est Lina", content: `<p>Lina est un concierge IA de voyage construit sur mesure — pas un chatbot générique. Bâtie sur Anthropic Claude avec une infrastructure qui se connecte aux partenaires de réservation en direct (Duffel pour les vols, LiteAPI pour 1,5 M+ hôtels), Lina peut planifier ET coordonner toute la réservation de ton voyage chez les fournisseurs partenaires à partir d'une seule conversation.</p><p>Elle est la porte d'entrée de Zeniva, une plateforme technologique de voyage IA basée aux USA, incorporée au Delaware. Zeniva agit uniquement comme intermédiaire technologique — les services de voyage sont fournis par des fournisseurs tiers identifiés au paiement. Quand tu parles à Lina, tu parles au même cerveau qui orchestre des milliers de voyages par mois — mais personnalisé pour tes dates, groupe, budget et style.</p>` },
