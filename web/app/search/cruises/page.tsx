...
const sampleCruises: CruiseOption[] = [
  ...
  { id: "cru-4", name: "Greek Isles Discovery", line: "Azamara", route: "Athens → Mykonos → Paros → Rhodes", dates: "Jun 2 - Jun 9", duration: "7 nights", price: "$1,620 / person", cabin: "Veranda", perks: ["Gratuities", "Wi-Fi", "Smaller ship"], badge: "Small ship", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=80" },
...
export default function CruisesSearchPage({ searchParams }: { searchParams: Params }) {
  ...
  const askPrompt = `Shortlist cruises${region ? ` in ${region}` : ""} departing ${summary.when} for ${summary.pax}, duration ${summary.dur}. Show value and top picks. Keep ${selectedId} selected and compare 2 alternatives.`;
