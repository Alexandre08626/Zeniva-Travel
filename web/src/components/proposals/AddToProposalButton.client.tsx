...
type AddToProposalButtonProps = {
  title: string;
  destination: string;
  accommodationType: "Zeniva Home" | "Residence" | "Yacht" | "Resort" | "Hotel";
  style?: string;
  price?: string;
  image: string;
  images?: string[];
...
export default function AddToProposalButton({
  ...
  const handleClick = async () => {
    ...
    if ((accommodationType === "Zeniva Home" || accommodationType === "Residence") && price && /night/i.test(price) && checkIn && checkOut) {
