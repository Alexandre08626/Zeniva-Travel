...
const WIDGET_TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    "ZeniHotel": "ZeniHotel",
    "ZeniTransfers": "ZeniTransfers",
    "ZeniCar": "ZeniCar",
    "ZeniXP": "ZeniXP",
    "ZeniCruise": "ZeniCruise",
    "ZeniYacht": "ZeniYacht",
    "ZeniStay": "ZeniStay",
      ...
      <div className="hidden sm:block">
        ...
        <div className="mb-5 flex items-center justify-center gap-2 flex-wrap">
          {[
            ...
            { key: 'hotels', label: 'ZeniHotel', icon: '🏨' },
            { key: 'transfers', label: 'ZeniTransfers', icon: '🚐' },
            { key: 'cars', label: 'ZeniCar', icon: '🚗' },
            { key: 'experiences', label: 'ZeniXP', icon: '🎯' },
            { key: 'cruises', label: 'ZeniCruise', icon: '🚢' },
