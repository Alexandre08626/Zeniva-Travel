...
YOUR GREETING (say this ONCE immediately when the call starts, then wait):
...
export const LINA_REALTIME_TOOLS = [
  {
    type: "function" as const,
    name: "update_trip",
    description:
      "Update the trip snapshot with collected information. Call this every time you learn new details from the client (destination, dates, travelers, budget, style, etc). Call it multiple times as you collect more info.",
    parameters: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description:
      "Generate a travel proposal when the client confirms they want to proceed. Only call this after you have collected enough information (at minimum: destination, dates, and number of travelers).",
    parameters: {
      type: "object",
      properties: {
...
export const LINA_REALTIME_TURN_DETECTION = {
...
export const LINA_REALTIME_INPUT_TRANSCRIPTION = { model: "whisper-1" };
