...
export const mockListings = [
  ...
  },
  {
    ...
    partnerId: 'partner-yacht-01',
    ownerId: 'owner-001',
    title: 'YCN 62ft Leopard Power Cat',
    type: 'yacht',
    status: 'published',
    ...
    bedrooms: 4,
    bathrooms: 3,
    description: 'Sleek 62ft power catamaran with crew, perfect for day charters in Miami and the Keys.',
    amenities: ['WiFi', 'Crew', 'Water Toys', 'Sound System', 'Shaded Lounge', 'Tender'],
    views: 1240,
    bookings: 18,
    revenue: 78000,
    rating: 4.9,
  ...
  },
  {
    ...
    bedrooms: 4,
    bathrooms: 3,
    description: 'Chalet au Canada, Lac-Beauport. Vue sur le lac, accès aux pistes, ambiance cosy pour hiver et été.',
    amenities: ['WiFi', 'Fireplace', 'Ski Storage', 'Hot Tub', 'Lake Views', 'Parking'],
    views: 3241,
    bookings: 45,
    revenue: 20250,
    rating: 4.8,
  ...
  },
  {
    ...
    ownerId: 'owner-005',
    title: 'Pearl Resort Overwater Suite',
    type: 'hotel',
    status: 'published',
    thumbnail: 'https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=800&q=80',
    ...
    bedrooms: 1,
    bathrooms: 1,
    description: 'Iconic overwater suite with lagoon views, private deck, and butler service.',
    amenities: ['Overwater Deck', 'Lagoon View', 'Butler', 'Breakfast Included', 'Spa Access'],
    views: 2980,
    bookings: 44,
    revenue: 118000,
    rating: 5.0,
  ...
  },
  {
    ...
    partnerId: 'partner-resort-02',
    ownerId: 'owner-005',
    title: 'Pearl Resort Lagoon Villa',
    type: 'hotel',
    status: 'published',
    thumbnail: 'https://images.unsplash.com/photo-1501117170019-8782a8e5f9b8?w=800&q=80',
    location: 'Bora Bora, French Polynesia',
    price: 980,
    currency: 'USD',
    capacity: 3,
    bedrooms: 1,
    bathrooms: 1,
    description: 'Lagoon-front villa with private plunge pool, steps from the beach.',
    amenities: ['Private Pool', 'Lagoon Access', 'Concierge', 'Breakfast Included'],
    views: 2140,
    bookings: 31,
    revenue: 86000,
    rating: 4.9,
  ...
  },
  {
    ...
    ownerId: 'owner-006',
    title: 'Tribe Resort Oceanview Room',
    type: 'hotel',
    status: 'published',
    ...
    bedrooms: 1,
    bathrooms: 1,
    description: 'Modern oceanview room with balcony, steps to the beach and resort amenities.',
    amenities: ['Ocean View', 'Balcony', 'All-Inclusive', 'Gym', 'Pool'],
    views: 910,
    bookings: 12,
    revenue: 18200,
    rating: 4.7,
